...
const experiences = [
  {
    id: 1,
    company: "MGC-Million Genius Coders",
    role: "Java Developer Intern",
    duration: "Jun 2024 – Jan 2025",
    period: "2024-25",
    description: [
      "Collaborated on real-time content creation for technical documentation.",
      " Assisted in Java planning and prototyping.",
      "Gained hands-on experience in software development lifecycle.",
    ]
  },
  {
    id: 2,
    company: "Foresight software solutions",
    role: ".net Developer Intern",
    duration: "Jun 2025 – Dec 2025",
    period: "2025",
    description: [
      "Contributed to development of e-commerce platforms and ERP systems in a startup environment.",
      "Assisted in planning, prototyping, and system design",
