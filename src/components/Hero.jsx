            ...
            <div className="relative z-10  max-w-7xl mx-auto px-6 flex flex-col md:flex-row items-center justify-between w-full">
                ...
                >
                    ...
                    >
                        <span style={{ fontWeight: 800, fontFamily: "Inter, sans-serif" }}>
                            Hi, I'm Sowdhanya Laxna Vijayakumar
                        </span>
                    </GradientText>

                    <div className="text-xl md:text-2xl text-gray-300 font-medium mb-6 font-mono">
                        <TextType
                            text={["Designing Experiences. Building Systems. Securing the Future"]}
                            typingSpeed={60}
                            pauseDuration={4000}
                            showCursor={true}
                            cursorCharacter="_"
                    ...
                    <p className="text-gray-300 text-sm md:text-base leading-relaxed max-w-lg font-medium"
                        ...
                        Software Developer with 2+ years of startup experience in 
                        .NET and Java development. Strong foundation in UI/UX and
                        full-stack technologies including HTML, CSS, JavaScript, SQL, Python, and Java. 
                        Currently focused on mastering React and Cybersecurity to build modern, secure, 
                ...
                >
                    <div className="relative">
                        <img
                            src={`${import.meta.env.BASE_URL}/images/profile.jpeg.png`}
                            alt="Sowdhanhya"
