...
const ContactSection = () => {
  ...
  const handleResumeDownload = () => {
    ...
    const resumePath = `${import.meta.env.BASE_URL}/resume/Sowdhanya_resume.pdf`;
    const link = document.createElement('a');
    link.href = resumePath;
    link.download = 'Sowdhanya_resume.pdf';
  ...
  const contactInfo = {
    email: "sowdhanya294@gmail.com",
    phone: "+91-9361077188",
    location: "Coimbatore , India",
    timezone: "GMT +5:30",
    linkedin: "https://www.linkedin.com/in/sowdhanya-laxna-vijayakumar/",
    github: "https://github.com/Sowdhanya-laxna",
