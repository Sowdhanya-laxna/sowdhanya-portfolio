...
const projectsData = [
    {
        id: 1,
        title: "Blockchain Forensics System for Tracking Darknet Drug Transactions",
        category: "Cybersecurity & Blockchain",
        period: "may 2025 - Sept 2025",
        status: "Completed",
        type: "Academic",
        description: "A blockchain forensics system designed to track and analyze illicit cryptocurrency transactions associated with darknet drug activities. The system leverages graph analysis and machine learning to detect suspicious patterns, identify mixers, and assign risk scores to transactions.",
        longDescription: "This project focuses on building an intelligent blockchain forensics platform to monitor and investigate darknet drug-related cryptocurrency transactions. The system collects transaction data from blockchain networks and stores it using IPFS for decentralization and integrity. It performs transaction graph analysis to trace fund flows, detect anomalies using machine learning models, and identify the usage of cryptocurrency mixers. Additionally, it integrates OSINT techniques to enrich investigation data and provides a visual dashboard for investigators to explore transaction relationships. A risk scoring mechanism is implemented to prioritize suspicious activities, enabling efficient cybercrime investigations.",
        technologies: ["Python", "Blockchain", "IPFS", "Machine Learning", "Graph Analysis", "Angular", "Chart.js", "WebSockets"],
         skills: [
        { name: "Python", level: 90 },
        { name: "Blockchain Analysis", level: 88 },
        { name: "Machine Learning", level: 85 },
        { name: "Cybersecurity", level: 87 },
        { name: "Data Visualization", level: 82 }
    ],
       achievements: [
        "Developed transaction graph analysis for tracking fund flow",
        "Implemented anomaly detection using ML algorithms",
        "Identified cryptocurrency mixers used in illicit transactions",
        "Built risk scoring system for prioritizing threats",
        "Designed interactive investigation dashboard"
        ],        links: {
    ...
    description: "A hotel management system designed to streamline hotel operations including room booking, customer management, billing, and service tracking. The system provides an efficient and user-friendly interface for both administrators and customers.",
    
    longDescription: "The Hotel Management System is a full-stack web application developed to automate and manage day-to-day hotel operations. It enables users to book rooms, check availability in real-time, and manage reservations seamlessly. The system includes features such as customer data management, billing and invoice generation, room allocation, and service requests. Admins can monitor occupancy rates, manage staff operations, and generate reports for better decision-making. The platform is designed with a responsive UI/UX to ensure smooth usability across devices and enhances operational efficiency while reducing manual workload.",
    ...
    achievements: [
        "Implemented real-time room booking and availability tracking",
        "Developed secure user authentication and admin dashboard",
        ...
        links: {
            github: "https://github.com/Sowdhanya-laxna/Hotel-Management-System",
            demo: "https://github.com/Sowdhanya-laxna/Hotel-Management-System",
            documentation: "https://github.com/Sowdhanya-laxna/Hotel-Management-System"
        },
    ...
    {
        id: 3,
        title: "Next Gen Virtual Reality - UI Design",
    category: "UI/UX Design",
    period: "2024",
    status: "Completed",
    type: "Design Project",
    description: "A modern and visually immersive landing page UI designed for a virtual reality product using Figma, focusing on futuristic aesthetics and user engagement.",
    
    longDescription: "This project showcases a cutting-edge landing page UI concept for a next-generation virtual reality product. Designed entirely in Figma, the interface emphasizes futuristic design elements, smooth user flow, and immersive visual storytelling. The layout incorporates bold typography, gradient effects, and interactive components to reflect the advanced nature of VR technology. The design prioritizes user experience by ensuring clear navigation, engaging call-to-actions, and responsive adaptability. This project highlights strong UI/UX principles, creativity, and attention to detail in crafting visually appealing digital experiences.",
    
    technologies: ["Figma", "UI Design", "UX Research", "Prototyping", "Wireframing"],
    ...
    achievements: [
        "Designed a futuristic and immersive VR landing page",
        "Created high-fidelity UI components and design system",
        "Developed interactive prototypes for user flow visualization",
        "Applied modern design trends like gradients and glassmorphism",
        "Ensured responsive and user-centric design approach"
        ],
        links: {
            github: "https://github.com/Sowdhanya-laxna/vr-ui-design?tab=readme-ov-file",
            demo: "https://github.com/Sowdhanya-laxna/vr-ui-design?tab=readme-ov-file",
            documentation:"https://github.com/Sowdhanya-laxna/vr-ui-design?tab=readme-ov-file"
        },
