...
const BlogSection = () => {
  // AI, Blockchain, and Cryptocurrency blog posts
  const blogPosts = [
    {
      id: 1,
      title: "Agentic AI in DeFi: The Future of Autonomous Finance",
      excerpt: "How autonomous AI agents are revolutionizing portfolio rebalancing, risk management, and smart contract interaction in decentralized markets.",
      date: "April 10, 2026",
      readTime: "9 min read",
      category: "Blockchain & AI",
      tags: ["DeFi", "Agentic-AI", "Web3", "Automation"],
      color: "#8b5cf6"
    },
    {
      id: 2,
      title: "Securing the Future: Post-Quantum Cryptography for Blockchains",
      excerpt: "Preparing decentralized networks for the quantum era by transitioning to next-generation cryptographic protocols that safeguard user assets.",
      date: "April 05, 2026",
      readTime: "7 min read",
      category: "Crypto Security",
      tags: ["Cryptography", "Quantum", "Security", "Blockchain"],
      color: "#f472b6"
    },
    {
      id: 3,
      title: "Tokenization of Real-World Assets (RWA) at Scale",
      excerpt: "Exploring how blockchain enables fractional ownership of real estate and commodities, powered by transparent, on-chain valuation models.",
      date: "April 28, 2026",
      readTime: "11 min read",
      category: "Fintech",
      tags: ["RWA", "Tokenization", "Assets", "Enterprise"],
      color: "#fbbf24"
    }
  ];
