...
const Footer = () => {
    ...
    const socialLinks = [
        { icon: FiGithub, href: "https://github.com/Sowdhanya-laxna", label: "GitHub", color: "#ffffff" },
        { icon: FiLinkedin, href: "https://www.linkedin.com/in/sowdhanya-laxna-vijayakumar/", label: "LinkedIn", color: "#0077b5" },
        { icon: FiMail, href: "mailto:sowdhanya294@gmail.com", label: "Email", color: "#ea4335" },
    ];
                    ...
                    <div>
                        ...
                        >
                            ...
                            <div className="space-y-3">
                                <motion.a
                                    href="mailto:sowdhanya294@gmail.com"
                                ...
                                <motion.a
                                    href={`${import.meta.env.BASE_URL}/resume/Sowdhanya_resume.pdf`}
                                    download
                                    className="flex items-center gap-3 p-3 rounded-lg text-white/70 hover:text-white text-sm transition-all duration-300 group"
                                    style={{
                                        background: 'linear-gradient(135deg, rgba(255,255,255,0.05) 0%, rgba(255,255,255,0.02) 100%)',
                ...
                <div className="max-w-7xl mx-auto px-6 md:px-12 lg:px-20 py-8">
                    <div className="flex flex-col md:flex-row items-center justify-between gap-6">
                        ...
                        >
                            ...
                            <span>by Sowdhanya Laxna Vijayakumar</span>
                        </motion.div>
