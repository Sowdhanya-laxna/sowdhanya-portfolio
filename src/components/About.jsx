    ...
    >
      ...
      <div className="relative z-10">
        ...
        <div className="max-w-7xl mx-auto px-6 flex flex-col lg:flex-row items-start justify-between gap-12">
          ...
          >
           {/* First Paragraph with Full-Stack Engineering Gradient */}
            <div className="text-lg md:text-xl leading-relaxed font-semibold font-[Inter,sans-serif] text-gray-200 mb-6">
              <span>Hi, I'm Sowdhanya, a Full-Stack Engineer and Researcher. I bridge the gap between </span>
              <span className="bg-gradient-to-r from-cyan-400 via-blue-500 to-purple-500 bg-clip-text text-transparent font-bold">
                Enterprise Systems
              </span>
              <span> and cutting-edge intelligent applications.</span>
            </div>

            {/* Second Paragraph with Stack and Security Gradients */}
            <div className="text-lg md:text-xl leading-relaxed font-medium font-[Inter,sans-serif] text-gray-200 mb-6">
              <span>With 2 years of experience in .NET and Java development, I now specialize in </span>
              <span className="bg-gradient-to-r from-green-400 via-emerald-500 to-teal-500 bg-clip-text text-transparent font-bold">
                React, Python, & SQL
              </span>
              <span>. I am passionate about building secure, scalable solutions while actively exploring the frontiers of </span>
                ...
                items={[
                  {
                    ...
                    description: "Professional background in .NET and Java development within fast-paced startup environments.",
                    id: 1,
                    icon: "💼",
                  },
                  {
                    title: "Full-Stack Development",
                    description: "Building modern, responsive interfaces with React, JS, and CSS, supported by robust .NET/Java backends.",
                    id: 2,
                    icon: "⚛️",
                  },
                  {
                    title: "Security & Forensics",
                    description: "Deepening expertise in Cybersecurity, smart contract auditing, and automated system threat detection.",
                    id: 3,
                    icon: "🛡️",
                  },
                  {
                    title: "AI & Innovation",
                    description: "Developing intelligent platforms like LAWGO and Nuance utilizing NLP, RAG, and Python.",
                    id: 4,
                    icon: "🤖",
                  },
                  {
                    title: "System Architecture",
                    description: "Passionate about clean code, scalable architecture, and bridging business logic with technical precision.",
                    id: 5,
                    icon: "🏗️",
                  },
                ]}
